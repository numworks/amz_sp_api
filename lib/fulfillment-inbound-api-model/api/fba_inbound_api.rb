...
module AmzSpApi::FulfillmentInboundApiModel
  class FbaInboundApi
    ...
    # @param shipment_id [String] A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param need_by_date [Date] Date that the shipment must arrive at the Amazon fulfillment center to avoid delivery promise breaks for pre-ordered items. Must be in YYYY-MM-DD format. The response to the getPreorderInfo operation returns this value.
    ...
    def confirm_preorder_with_http_info(shipment_id, need_by_date, marketplace_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}/preorder/confirm'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ConfirmPreorderResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.confirm_preorder",
    ...
    def confirm_transport_with_http_info(shipment_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}/transport/confirm'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ConfirmTransportResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.confirm_transport",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param shipment_id [String] A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param body [InboundShipmentRequest] 
    # @param [Hash] opts the optional parameters
    # @return [InboundShipmentResponse]
    def create_inbound_shipment(shipment_id, body, opts = {})
      data, _status_code, _headers = create_inbound_shipment_with_http_info(shipment_id, body, opts)
      data
    end
    ...
    def create_inbound_shipment_with_http_info(shipment_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InboundShipmentResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.create_inbound_shipment",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param body [CreateInboundShipmentPlanRequest] 
    # @param [Hash] opts the optional parameters
    ...
    def create_inbound_shipment_plan_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateInboundShipmentPlanResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.create_inbound_shipment_plan",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def estimate_transport_with_http_info(shipment_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}/transport/estimate'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EstimateTransportResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.estimate_transport",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_bill_of_lading_with_http_info(shipment_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}/billOfLading'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetBillOfLadingResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.get_bill_of_lading",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param marketplace_id [String] A marketplace identifier. Specifies the marketplace where the product would be stored.
    # @param [Hash] opts the optional parameters
    ...
    def get_inbound_guidance_with_http_info(marketplace_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetInboundGuidanceResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.get_inbound_guidance",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param shipment_id [String] A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param page_type [String] The page type to use to print the labels. Submitting a PageType value that is not supported in your marketplace returns an error.
    ...
    def get_labels_with_http_info(shipment_id, page_type, label_type, opts = {})
      ...
      # verify enum value
      allowable_values = ["PackageLabel_Letter_2", "PackageLabel_Letter_4", "PackageLabel_Letter_6", "PackageLabel_Letter_6_CarrierLeft", "PackageLabel_A4_2", "PackageLabel_A4_4", "PackageLabel_Plain_Paper", "PackageLabel_Plain_Paper_CarrierBottom", "PackageLabel_Thermal", "PackageLabel_Thermal_Unified", "PackageLabel_Thermal_NonPCP", "PackageLabel_Thermal_No_Carrier_Rotation"]
      if @api_client.config.client_side_validation && !allowable_values.include?(page_type)
        fail ArgumentError, "invalid value for \"page_type\", must be one of #{allowable_values}"
      end
      ...
      # verify enum value
      allowable_values = ["BARCODE_2D", "UNIQUE", "PALLET"]
      if @api_client.config.client_side_validation && !allowable_values.include?(label_type)
        fail ArgumentError, "invalid value for \"label_type\", must be one of #{allowable_values}"
      end
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}/labels'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetLabelsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.get_labels",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_preorder_info_with_http_info(shipment_id, marketplace_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}/preorder'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetPreorderInfoResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.get_preorder_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param ship_to_country_code [String] The country code of the country to which the items will be shipped. Note that labeling requirements and item preparation instructions can vary by country.
    # @param [Hash] opts the optional parameters
    ...
    def get_prep_instructions_with_http_info(ship_to_country_code, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetPrepInstructionsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.get_prep_instructions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param query_type [String] Indicates whether items are returned using a date range (by providing the LastUpdatedAfter and LastUpdatedBefore parameters), or using NextToken, which continues returning items specified in a previous request.
    # @param marketplace_id [String] A marketplace identifier. Specifies the marketplace where the product would be stored.
    # @param [Hash] opts the optional parameters
    # @option opts [Time] :last_updated_after A date used for selecting inbound shipment items that were last updated after (or at) a specified time. The selection includes updates made by Amazon and by the seller.
    # @option opts [Time] :last_updated_before A date used for selecting inbound shipment items that were last updated before (or at) a specified time. The selection includes updates made by Amazon and by the seller.
    ...
    def get_shipment_items_with_http_info(query_type, marketplace_id, opts = {})
      ...
      # verify enum value
      allowable_values = ["DATE_RANGE", "NEXT_TOKEN"]
      if @api_client.config.client_side_validation && !allowable_values.include?(query_type)
        fail ArgumentError, "invalid value for \"query_type\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'marketplace_id' is set
      if @api_client.config.client_side_validation && marketplace_id.nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetShipmentItemsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.get_shipment_items",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_shipment_items_by_shipment_id_with_http_info(shipment_id, marketplace_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}/items'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"FbaInboundApi.get_shipment_items_by_shipment_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param query_type [String] Indicates whether shipments are returned using shipment information (by providing the ShipmentStatusList or ShipmentIdList parameters), using a date range (by providing the LastUpdatedAfter and LastUpdatedBefore parameters), or by using NextToken to continue returning items specified in a previous request.
    # @param marketplace_id [String] A marketplace identifier. Specifies the marketplace where the product would be stored.
    # @param [Hash] opts the optional parameters
    ...
    # @option opts [Time] :last_updated_after A date used for selecting inbound shipments that were last updated after (or at) a specified time. The selection includes updates made by Amazon and by the seller.
    # @option opts [Time] :last_updated_before A date used for selecting inbound shipments that were last updated before (or at) a specified time. The selection includes updates made by Amazon and by the seller.
    # @option opts [String] :next_token A string token returned in the response to your previous request.
    ...
    def get_shipments_with_http_info(query_type, marketplace_id, opts = {})
      ...
      # verify enum value
      allowable_values = ["SHIPMENT", "DATE_RANGE", "NEXT_TOKEN"]
      if @api_client.config.client_side_validation && !allowable_values.include?(query_type)
        fail ArgumentError, "invalid value for \"query_type\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'marketplace_id' is set
      ...
      allowable_values = ["WORKING", "READY_TO_SHIP", "SHIPPED", "RECEIVING", "CANCELLED", "DELETED", "CLOSED", "ERROR", "IN_TRANSIT", "DELIVERED", "CHECKED_IN"]
      if @api_client.config.client_side_validation && opts[:'shipment_status_list'] && !opts[:'shipment_status_list'].all? { |item| allowable_values.include?(item) }
        fail ArgumentError, "invalid value for \"shipment_status_list\", must include one of #{allowable_values}"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetShipmentsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.get_shipments",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_transport_details_with_http_info(shipment_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}/transport'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetTransportDetailsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.get_transport_details",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param shipment_id [String] A shipment identifier originally returned by the createInboundShipmentPlan operation.
    # @param body [PutTransportDetailsRequest] 
    # @param [Hash] opts the optional parameters
    ...
    def put_transport_details_with_http_info(shipment_id, body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PutTransportDetailsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.put_transport_details",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @return [InboundShipmentResponse]
    def update_inbound_shipment(shipment_id, body, opts = {})
      data, _status_code, _headers = update_inbound_shipment_with_http_info(shipment_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InboundShipmentResponse, Integer, Hash)>] InboundShipmentResponse data, response status code and response headers
    def update_inbound_shipment_with_http_info(shipment_id, body, opts = {})
      if @api_client.config.debugging
      ...
      new_options = opts.merge(
        :operation => :"FbaInboundApi.update_inbound_shipment",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def void_transport_with_http_info(shipment_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/inbound/v0/shipments/{shipmentId}/transport/void'.sub('{' + 'shipmentId' + '}', CGI.escape(shipment_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VoidTransportResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInboundApi.void_transport",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
