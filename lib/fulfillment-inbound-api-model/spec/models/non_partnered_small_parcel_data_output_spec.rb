...
describe AmzSpApi::FulfillmentInboundApiModel::NonPartneredSmallParcelDataOutput do
  let(:instance) { AmzSpApi::FulfillmentInboundApiModel::NonPartneredSmallParcelDataOutput.new }
