...
describe AmzSpApi::FulfillmentInboundApiModel::NonPartneredSmallParcelDataInput do
  let(:instance) { AmzSpApi::FulfillmentInboundApiModel::NonPartneredSmallParcelDataInput.new }
