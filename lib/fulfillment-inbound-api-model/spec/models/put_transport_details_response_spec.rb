...
describe AmzSpApi::FulfillmentInboundApiModel::PutTransportDetailsResponse do
  let(:instance) { AmzSpApi::FulfillmentInboundApiModel::PutTransportDetailsResponse.new }
