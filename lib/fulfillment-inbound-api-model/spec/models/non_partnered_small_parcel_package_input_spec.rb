...
describe AmzSpApi::FulfillmentInboundApiModel::NonPartneredSmallParcelPackageInput do
  let(:instance) { AmzSpApi::FulfillmentInboundApiModel::NonPartneredSmallParcelPackageInput.new }
