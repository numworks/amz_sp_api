...
module AmzSpApi::FulfillmentInboundApiModel
  class PrepGuidance
    ...
    def self.all_vars
      @all_vars ||= [CONSULT_HELP_DOCUMENTS, NO_ADDITIONAL_PREP_REQUIRED, SEE_PREP_INSTRUCTIONS_LIST].freeze
    end
    ...
    def build_from_hash(value)
      return value if PrepGuidance.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PrepGuidance"
    end
  end
end
