  ...
  class CreateInboundShipmentPlanRequest
    ...
    def self.openapi_types
      {
        ...
        :'inbound_shipment_plan_request_items' => :'Array<InboundShipmentPlanRequestItem>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'inbound_shipment_plan_request_items')
        if (value = attributes[:'inbound_shipment_plan_request_items']).is_a?(Array)
          self.inbound_shipment_plan_request_items = value
        end
      end
    end
