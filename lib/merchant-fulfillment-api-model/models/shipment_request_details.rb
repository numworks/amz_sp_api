...
module AmzSpApi::MerchantFulfillmentApiModel
  ...
  class ShipmentRequestDetails
    ...
    def list_invalid_properties
      ...
      if !@seller_order_id.nil? && @seller_order_id.to_s.length > 64
        invalid_properties.push('invalid value for "seller_order_id", the character length must be smaller than or equal to 64.')
      end
    ...
    def valid?
      ...
      return false if !@seller_order_id.nil? && @seller_order_id.to_s.length > 64
    ...
    # @param [Object] seller_order_id Value to be assigned
    def seller_order_id=(seller_order_id)
      if !seller_order_id.nil? && seller_order_id.to_s.length > 64
        fail ArgumentError, 'invalid value for "seller_order_id", the character length must be smaller than or equal to 64.'
      end
