...
module AmzSpApi::MerchantFulfillmentApiModel
  class PredefinedPackageDimensions
    ...
    def self.all_vars
      @all_vars ||= [FED_EX_BOX_10KG, FED_EX_BOX_25KG, FED_EX_BOX_EXTRA_LARGE_1, FED_EX_BOX_EXTRA_LARGE_2, FED_EX_BOX_LARGE_1, FED_EX_BOX_LARGE_2, FED_EX_BOX_MEDIUM_1, FED_EX_BOX_MEDIUM_2, FED_EX_BOX_SMALL_1, FED_EX_BOX_SMALL_2, FED_EX_ENVELOPE, FED_EX_PADDED_PAK, FED_EX_PAK_1, FED_EX_PAK_2, FED_EX_TUBE, FED_EX_XL_PAK, UPS_BOX_10KG, UPS_BOX_25KG, UPS_EXPRESS_BOX, UPS_EXPRESS_BOX_LARGE, UPS_EXPRESS_BOX_MEDIUM, UPS_EXPRESS_BOX_SMALL, UPS_EXPRESS_ENVELOPE, UPS_EXPRESS_HARD_PAK, UPS_EXPRESS_LEGAL_ENVELOPE, UPS_EXPRESS_PAK, UPS_EXPRESS_TUBE, UPS_LABORATORY_PAK, UPS_PAD_PAK, UPS_PALLET, USPS_CARD, USPS_FLAT, USPS_FLAT_RATE_CARDBOARD_ENVELOPE, USPS_FLAT_RATE_ENVELOPE, USPS_FLAT_RATE_GIFT_CARD_ENVELOPE, USPS_FLAT_RATE_LEGAL_ENVELOPE, USPS_FLAT_RATE_PADDED_ENVELOPE, USPS_FLAT_RATE_WINDOW_ENVELOPE, USPS_LARGE_FLAT_RATE_BOARD_GAME_BOX, USPS_LARGE_FLAT_RATE_BOX, USPS_LETTER, USPS_MEDIUM_FLAT_RATE_BOX1, USPS_MEDIUM_FLAT_RATE_BOX2, USPS_REGIONAL_RATE_BOX_A1, USPS_REGIONAL_RATE_BOX_A2, USPS_REGIONAL_RATE_BOX_B1, USPS_REGIONAL_RATE_BOX_B2, USPS_REGIONAL_RATE_BOX_C, USPS_SMALL_FLAT_RATE_BOX, USPS_SMALL_FLAT_RATE_ENVELOPE].freeze
    end
    ...
    def build_from_hash(value)
      return value if PredefinedPackageDimensions.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PredefinedPackageDimensions"
    end
  end
end
