  ...
  class Item
    ...
    def self.openapi_types
      {
        ...
        :'transparency_code_list' => :'Array<String>',
        :'item_level_seller_inputs_list' => :'Array<AdditionalSellerInputs>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'transparency_code_list')
        if (value = attributes[:'transparency_code_list']).is_a?(Array)
          self.transparency_code_list = value
        end
      end

      if attributes.key?(:'item_level_seller_inputs_list')
        if (value = attributes[:'item_level_seller_inputs_list']).is_a?(Array)
          self.item_level_seller_inputs_list = value
        end
      end
    end
