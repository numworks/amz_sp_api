...
describe AmzSpApi::MerchantFulfillmentApiModel::LabelFormatOptionRequest do
  let(:instance) { AmzSpApi::MerchantFulfillmentApiModel::LabelFormatOptionRequest.new }
