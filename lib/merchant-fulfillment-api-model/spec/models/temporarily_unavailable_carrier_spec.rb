...
describe AmzSpApi::MerchantFulfillmentApiModel::TemporarilyUnavailableCarrier do
  let(:instance) { AmzSpApi::MerchantFulfillmentApiModel::TemporarilyUnavailableCarrier.new }
