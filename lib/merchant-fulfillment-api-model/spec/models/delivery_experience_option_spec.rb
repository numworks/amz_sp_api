...
describe AmzSpApi::MerchantFulfillmentApiModel::DeliveryExperienceOption do
  let(:instance) { AmzSpApi::MerchantFulfillmentApiModel::DeliveryExperienceOption.new }
