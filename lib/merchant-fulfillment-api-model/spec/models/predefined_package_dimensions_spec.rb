...
describe AmzSpApi::MerchantFulfillmentApiModel::PredefinedPackageDimensions do
  let(:instance) { AmzSpApi::MerchantFulfillmentApiModel::PredefinedPackageDimensions.new }
