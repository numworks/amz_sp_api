...
describe AmzSpApi::FbaSmallAndLightApiModel::SmallAndLightFeePreviewRequest do
  let(:instance) { AmzSpApi::FbaSmallAndLightApiModel::SmallAndLightFeePreviewRequest.new }
