...
module AmzSpApi::FbaSmallAndLightApiModel
  class SmallAndLightApi
    ...
    # @param seller_sku [String] The seller SKU that identifies the item.
    # @param marketplace_ids [Array<String>] The marketplace in which to remove the item from the Small and Light program. Note: Accepts a single marketplace only.
    ...
    def delete_small_and_light_enrollment_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      ...
      # resource path
      local_var_path = '/fba/smallAndLight/v1/enrollments/{sellerSKU}'.sub('{' + 'sellerSKU' + '}', CGI.escape(seller_sku.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SmallAndLightApi.delete_small_and_light_enrollment_by_seller_sku",
    ...
    # @param seller_sku [String] The seller SKU that identifies the item.
    # @param marketplace_ids [Array<String>] The marketplace for which the eligibility status is retrieved. NOTE: Accepts a single marketplace only.
    # @param [Hash] opts the optional parameters
    ...
    def get_small_and_light_eligibility_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      ...
      # resource path
      local_var_path = '/fba/smallAndLight/v1/eligibilities/{sellerSKU}'.sub('{' + 'sellerSKU' + '}', CGI.escape(seller_sku.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SmallAndLightEligibility'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SmallAndLightApi.get_small_and_light_eligibility_by_seller_sku",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param seller_sku [String] The seller SKU that identifies the item.
    # @param marketplace_ids [Array<String>] The marketplace for which the enrollment status is retrieved. Note: Accepts a single marketplace only.
    # @param [Hash] opts the optional parameters
    ...
    def get_small_and_light_enrollment_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SmallAndLightEnrollment'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SmallAndLightApi.get_small_and_light_enrollment_by_seller_sku",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param body [SmallAndLightFeePreviewRequest] 
    # @param [Hash] opts the optional parameters
    ...
    def get_small_and_light_fee_preview_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SmallAndLightFeePreviews'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SmallAndLightApi.get_small_and_light_fee_preview",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param seller_sku [String] The seller SKU that identifies the item.
    # @param marketplace_ids [Array<String>] The marketplace in which to enroll the item. Note: Accepts a single marketplace only.
    # @param [Hash] opts the optional parameters
    # @return [SmallAndLightEnrollment]
    ...
    def put_small_and_light_enrollment_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SmallAndLightApi.put_small_and_light_enrollment_by_seller_sku",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
