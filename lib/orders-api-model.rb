...
require 'orders-api-model/models/approval_support_data_element'
...
require 'orders-api-model/models/get_order_approvals_response'
...
require 'orders-api-model/models/item_approval'
require 'orders-api-model/models/item_approval_action'
require 'orders-api-model/models/item_approval_action_changes'
require 'orders-api-model/models/item_approval_context'
require 'orders-api-model/models/item_approval_status'
require 'orders-api-model/models/item_approval_type'
require 'orders-api-model/models/item_buyer_info'
require 'orders-api-model/models/item_identifier'
...
require 'orders-api-model/models/order_approvals_response'
require 'orders-api-model/models/order_buyer_info'
require 'orders-api-model/models/order_item'
require 'orders-api-model/models/order_item_approval_request'
require 'orders-api-model/models/order_item_approvals'
...
require 'orders-api-model/models/update_items_approvals_error_response'
require 'orders-api-model/models/update_order_approvals_request'
...
# APIs
require 'orders-api-model/api/approvals_api'
