...
describe AmzSpApi::MessagingApiModel::CreateConfirmDeliveryDetailsResponse do
  let(:instance) { AmzSpApi::MessagingApiModel::CreateConfirmDeliveryDetailsResponse.new }
