...
describe AmzSpApi::MessagingApiModel::GetMessagingActionResponseEmbedded do
  let(:instance) { AmzSpApi::MessagingApiModel::GetMessagingActionResponseEmbedded.new }
