...
module AmzSpApi::SolicitationsApiModel
  class SolicitationsApi
    ...
    # @param amazon_order_id [String] An Amazon order identifier. This specifies the order for which a solicitation is sent.
    ...
    def create_product_review_and_seller_feedback_solicitation_with_http_info(amazon_order_id, marketplace_ids, opts = {})
      ...
      # resource path
      local_var_path = '/solicitations/v1/orders/{amazonOrderId}/solicitations/productReviewAndSellerFeedback'.sub('{' + 'amazonOrderId' + '}', CGI.escape(amazon_order_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateProductReviewAndSellerFeedbackSolicitationResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SolicitationsApi.create_product_review_and_seller_feedback_solicitation",
    ...
    # @param amazon_order_id [String] An Amazon order identifier. This specifies the order for which you want a list of available solicitation types.
    # @param marketplace_ids [Array<String>] A marketplace identifier. This specifies the marketplace in which the order was placed. Only one marketplace can be specified.
    # @param [Hash] opts the optional parameters
    ...
    def get_solicitation_actions_for_order_with_http_info(amazon_order_id, marketplace_ids, opts = {})
      ...
      # resource path
      local_var_path = '/solicitations/v1/orders/{amazonOrderId}'.sub('{' + 'amazonOrderId' + '}', CGI.escape(amazon_order_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetSolicitationActionsForOrderResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SolicitationsApi.get_solicitation_actions_for_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
