...
module AmzSpApi::UploadsApiModel
  class UploadsApi
    ...
    # @param marketplace_ids [Array<String>] A list of marketplace identifiers. This specifies the marketplaces where the upload will be available. Only one marketplace can be specified.
    # @param content_md5 [String] An MD5 hash of the content to be submitted to the upload destination. This value is used to determine if the data has been corrupted or tampered with during transit.
    ...
    def create_upload_destination_for_resource_with_http_info(marketplace_ids, content_md5, resource, opts = {})
      ...
      # resource path
      local_var_path = '/uploads/2020-11-01/uploadDestinations/{resource}'.sub('{' + 'resource' + '}', CGI.escape(resource.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateUploadDestinationResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"UploadsApi.create_upload_destination_for_resource",
