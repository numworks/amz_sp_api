...
describe AmzSpApi::FulfillmentOutboundApiModel::FulfillmentShipmentPackage do
  let(:instance) { AmzSpApi::FulfillmentOutboundApiModel::FulfillmentShipmentPackage.new }
