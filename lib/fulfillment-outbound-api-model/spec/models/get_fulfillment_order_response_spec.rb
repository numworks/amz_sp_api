...
describe AmzSpApi::FulfillmentOutboundApiModel::GetFulfillmentOrderResponse do
  let(:instance) { AmzSpApi::FulfillmentOutboundApiModel::GetFulfillmentOrderResponse.new }
