...
describe AmzSpApi::FulfillmentOutboundApiModel::CreateFulfillmentReturnResult do
  let(:instance) { AmzSpApi::FulfillmentOutboundApiModel::CreateFulfillmentReturnResult.new }
