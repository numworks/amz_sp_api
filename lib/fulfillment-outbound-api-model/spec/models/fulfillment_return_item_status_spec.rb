...
describe AmzSpApi::FulfillmentOutboundApiModel::FulfillmentReturnItemStatus do
  let(:instance) { AmzSpApi::FulfillmentOutboundApiModel::FulfillmentReturnItemStatus.new }
