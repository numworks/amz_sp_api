...
module AmzSpApi::FulfillmentOutboundApiModel
  class FbaOutboundApi
    ...
    def cancel_fulfillment_order_with_http_info(seller_fulfillment_order_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/cancel'.sub('{' + 'sellerFulfillmentOrderId' + '}', CGI.escape(seller_fulfillment_order_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CancelFulfillmentOrderResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.cancel_fulfillment_order",
    ...
    # @param body [CreateFulfillmentOrderRequest] 
    # @param [Hash] opts the optional parameters
    ...
    def create_fulfillment_order_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateFulfillmentOrderResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.create_fulfillment_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param body [CreateFulfillmentReturnRequest] 
    # @param [Hash] opts the optional parameters
    # @return [CreateFulfillmentReturnResponse]
    def create_fulfillment_return(seller_fulfillment_order_id, body, opts = {})
      data, _status_code, _headers = create_fulfillment_return_with_http_info(seller_fulfillment_order_id, body, opts)
      data
    end
    ...
    def create_fulfillment_return_with_http_info(seller_fulfillment_order_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/return'.sub('{' + 'sellerFulfillmentOrderId' + '}', CGI.escape(seller_fulfillment_order_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateFulfillmentReturnResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.create_fulfillment_return",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_feature_inventory_with_http_info(marketplace_id, feature_name, opts = {})
      ...
      # resource path
      local_var_path = '/fba/outbound/2020-07-01/features/inventory/{featureName}'.sub('{' + 'featureName' + '}', CGI.escape(feature_name.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetFeatureInventoryResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.get_feature_inventory",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_feature_sku_with_http_info(marketplace_id, feature_name, seller_sku, opts = {})
      ...
      # resource path
      local_var_path = '/fba/outbound/2020-07-01/features/inventory/{featureName}/{sellerSku}'.sub('{' + 'featureName' + '}', CGI.escape(feature_name.to_s)).sub('{' + 'sellerSku' + '}', CGI.escape(seller_sku.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetFeatureSkuResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.get_feature_sku",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_features_with_http_info(marketplace_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetFeaturesResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.get_features",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_fulfillment_order_with_http_info(seller_fulfillment_order_id, opts = {})
      ...
      # resource path
      local_var_path = '/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}'.sub('{' + 'sellerFulfillmentOrderId' + '}', CGI.escape(seller_fulfillment_order_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetFulfillmentOrderResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.get_fulfillment_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param body [GetFulfillmentPreviewRequest] 
    # @param [Hash] opts the optional parameters
    ...
    def get_fulfillment_preview_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetFulfillmentPreviewResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.get_fulfillment_preview",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_package_tracking_details_with_http_info(package_number, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetPackageTrackingDetailsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.get_package_tracking_details",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Time] :query_start_date A date used to select fulfillment orders that were last updated after (or at) a specified time. An update is defined as any change in fulfillment order status, including the creation of a new fulfillment order.
    ...
    def list_all_fulfillment_orders_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListAllFulfillmentOrdersResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.list_all_fulfillment_orders",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param language [String] The language that the TranslatedDescription property of the ReasonCodeDetails response object should be translated into.
    # @param [Hash] opts the optional parameters
    ...
    def list_return_reason_codes_with_http_info(seller_sku, language, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListReturnReasonCodesResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.list_return_reason_codes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param seller_fulfillment_order_id [String] The identifier assigned to the item by the seller when the fulfillment order was created.
    # @param body [SubmitFulfillmentOrderStatusUpdateRequest] 
    # @param [Hash] opts the optional parameters
    # @return [SubmitFulfillmentOrderStatusUpdateResponse]
    def submit_fulfillment_order_status_update(seller_fulfillment_order_id, body, opts = {})
      data, _status_code, _headers = submit_fulfillment_order_status_update_with_http_info(seller_fulfillment_order_id, body, opts)
      data
    end
    ...
    def submit_fulfillment_order_status_update_with_http_info(seller_fulfillment_order_id, body, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && seller_fulfillment_order_id.to_s.length > 40
        fail ArgumentError, 'invalid value for "seller_fulfillment_order_id" when calling FbaOutboundApi.submit_fulfillment_order_status_update, the character length must be smaller than or equal to 40.'
      end
      ...
      # resource path
      local_var_path = '/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/status'.sub('{' + 'sellerFulfillmentOrderId' + '}', CGI.escape(seller_fulfillment_order_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SubmitFulfillmentOrderStatusUpdateResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.submit_fulfillment_order_status_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param seller_fulfillment_order_id [String] The identifier assigned to the item by the seller when the fulfillment order was created.
    # @param body [UpdateFulfillmentOrderRequest] 
    # @param [Hash] opts the optional parameters
    # @return [UpdateFulfillmentOrderResponse]
    def update_fulfillment_order(seller_fulfillment_order_id, body, opts = {})
      data, _status_code, _headers = update_fulfillment_order_with_http_info(seller_fulfillment_order_id, body, opts)
      data
    end
    ...
    def update_fulfillment_order_with_http_info(seller_fulfillment_order_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UpdateFulfillmentOrderResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaOutboundApi.update_fulfillment_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
