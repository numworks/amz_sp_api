  ...
  class FulfillmentShipment
    ...
    def self.openapi_types
      {
        ...
        :'fulfillment_shipment_item' => :'Array<FulfillmentShipmentItem>',
        :'fulfillment_shipment_package' => :'Array<FulfillmentShipmentPackage>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'fulfillment_shipment_item')
        if (value = attributes[:'fulfillment_shipment_item']).is_a?(Array)
          self.fulfillment_shipment_item = value
        end
      end

      if attributes.key?(:'fulfillment_shipment_package')
        if (value = attributes[:'fulfillment_shipment_package']).is_a?(Array)
          self.fulfillment_shipment_package = value
        end
      end
    end
