  ...
  class FulfillmentPreview
    ...
    def self.openapi_types
      {
        ...
        :'unfulfillable_preview_items' => :'Array<UnfulfillablePreviewItem>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'fulfillment_preview_shipments')
        if (value = attributes[:'fulfillment_preview_shipments']).is_a?(Array)
          self.fulfillment_preview_shipments = value
        end
      end

      if attributes.key?(:'unfulfillable_preview_items')
        if (value = attributes[:'unfulfillable_preview_items']).is_a?(Array)
          self.unfulfillable_preview_items = value
        end
      end

      if attributes.key?(:'order_unfulfillable_reasons')
        if (value = attributes[:'order_unfulfillable_reasons']).is_a?(Array)
          self.order_unfulfillable_reasons = value
        end
      end
