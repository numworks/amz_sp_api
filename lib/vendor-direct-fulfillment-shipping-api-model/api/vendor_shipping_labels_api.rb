  ...
  class VendorShippingLabelsApi
    ...
    def get_shipping_label_with_http_info(purchase_order_number, opts = {})
      ...
      if @api_client.config.client_side_validation && purchase_order_number !~ pattern
        fail ArgumentError, "invalid value for 'purchase_order_number' when calling VendorShippingLabelsApi.get_shipping_label, must conform to the pattern #{pattern}."
      end

      # resource path
      local_var_path = '/vendor/directFulfillment/shipping/v1/shippingLabels/{purchaseOrderNumber}'.sub('{' + 'purchaseOrderNumber' + '}', CGI.escape(purchase_order_number.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetShippingLabelResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"VendorShippingLabelsApi.get_shipping_label",
    ...
    # @param created_after [Time] Shipping labels that became available after this date and time will be included in the result. Must be in ISO-8601 date/time format.
    # @param created_before [Time] Shipping labels that became available before this date and time will be included in the result. Must be in ISO-8601 date/time format.
    # @param [Hash] opts the optional parameters
    ...
    def get_shipping_labels_with_http_info(created_after, created_before, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetShippingLabelListResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"VendorShippingLabelsApi.get_shipping_labels",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param body [SubmitShippingLabelsRequest] 
    # @param [Hash] opts the optional parameters
    ...
    def submit_shipping_label_request_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SubmitShippingLabelsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"VendorShippingLabelsApi.submit_shipping_label_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
