...
describe AmzSpApi::VendorDirectFulfillmentShippingApiModel::SubmitShippingLabelsResponse do
  let(:instance) { AmzSpApi::VendorDirectFulfillmentShippingApiModel::SubmitShippingLabelsResponse.new }
