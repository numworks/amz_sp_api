...
module AmzSpApi::VendorDirectFulfillmentShippingApiModel
  class CustomerInvoice
    ...
    def list_invalid_properties
      ...
      if @purchase_order_number !~ pattern
        invalid_properties.push("invalid value for \"purchase_order_number\", must conform to the pattern #{pattern}.")
      end
    ...
    def purchase_order_number=(purchase_order_number)
      ...
      pattern = Regexp.new(/^[a-zA-Z0-9]+$/)
      if purchase_order_number !~ pattern
        fail ArgumentError, "invalid value for \"purchase_order_number\", must conform to the pattern #{pattern}."
      end
