...
module AmzSpApi::TokensApiModel
  class TokensApi
    ...
    # @param body [CreateRestrictedDataTokenRequest] The restricted data token request details.
    ...
    def create_restricted_data_token_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateRestrictedDataTokenResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TokensApi.create_restricted_data_token",
