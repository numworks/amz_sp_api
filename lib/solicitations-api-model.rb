...
require 'solicitations-api-model/models/get_schema_response_links'
require 'solicitations-api-model/models/get_solicitation_action_response'
require 'solicitations-api-model/models/get_solicitation_action_response_embedded'
require 'solicitations-api-model/models/get_solicitation_action_response_links'
require 'solicitations-api-model/models/get_solicitation_actions_for_order_response'
require 'solicitations-api-model/models/get_solicitation_actions_for_order_response_embedded'
require 'solicitations-api-model/models/get_solicitation_actions_for_order_response_links'
