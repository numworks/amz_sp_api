  ...
  class RetrochargeEvent
    ...
    def self.openapi_types
      {
        ...
        :'retrocharge_tax_withheld_list' => :'Array<TaxWithheldComponent>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'retrocharge_tax_withheld_list')
        if (value = attributes[:'retrocharge_tax_withheld_list']).is_a?(Array)
          self.retrocharge_tax_withheld_list = value
        end
      end
    end
