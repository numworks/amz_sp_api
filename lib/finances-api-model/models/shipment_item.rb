  ...
  class ShipmentItem
    ...
    def self.openapi_types
      {
        ...
        :'item_charge_list' => :'Array<ChargeComponent>',
        :'item_charge_adjustment_list' => :'Array<ChargeComponent>',
        :'item_fee_list' => :'Array<FeeComponent>',
        :'item_fee_adjustment_list' => :'Array<FeeComponent>',
        :'item_tax_withheld_list' => :'Array<TaxWithheldComponent>',
        :'promotion_list' => :'Array<Promotion>',
        :'promotion_adjustment_list' => :'Array<Promotion>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'item_charge_list')
        if (value = attributes[:'item_charge_list']).is_a?(Array)
          self.item_charge_list = value
        end
      end

      if attributes.key?(:'item_charge_adjustment_list')
        if (value = attributes[:'item_charge_adjustment_list']).is_a?(Array)
          self.item_charge_adjustment_list = value
        end
      end

      if attributes.key?(:'item_fee_list')
        if (value = attributes[:'item_fee_list']).is_a?(Array)
          self.item_fee_list = value
        end
      end

      if attributes.key?(:'item_fee_adjustment_list')
        if (value = attributes[:'item_fee_adjustment_list']).is_a?(Array)
          self.item_fee_adjustment_list = value
        end
      end

      if attributes.key?(:'item_tax_withheld_list')
        if (value = attributes[:'item_tax_withheld_list']).is_a?(Array)
          self.item_tax_withheld_list = value
        end
      end

      if attributes.key?(:'promotion_list')
        if (value = attributes[:'promotion_list']).is_a?(Array)
          self.promotion_list = value
        end
      end

      if attributes.key?(:'promotion_adjustment_list')
        if (value = attributes[:'promotion_adjustment_list']).is_a?(Array)
          self.promotion_adjustment_list = value
        end
      end
