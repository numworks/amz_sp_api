  ...
  class ShipmentEvent
    ...
    def self.openapi_types
      {
        ...
        :'order_charge_list' => :'Array<ChargeComponent>',
        :'order_charge_adjustment_list' => :'Array<ChargeComponent>',
        :'shipment_fee_list' => :'Array<FeeComponent>',
        :'shipment_fee_adjustment_list' => :'Array<FeeComponent>',
        :'order_fee_list' => :'Array<FeeComponent>',
        :'order_fee_adjustment_list' => :'Array<FeeComponent>',
        :'direct_payment_list' => :'Array<DirectPayment>',
        :'posted_date' => :'Time',
        :'shipment_item_list' => :'Array<ShipmentItem>',
        :'shipment_item_adjustment_list' => :'Array<ShipmentItem>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'order_charge_list')
        if (value = attributes[:'order_charge_list']).is_a?(Array)
          self.order_charge_list = value
        end
      end

      if attributes.key?(:'order_charge_adjustment_list')
        if (value = attributes[:'order_charge_adjustment_list']).is_a?(Array)
          self.order_charge_adjustment_list = value
        end
      end

      if attributes.key?(:'shipment_fee_list')
        if (value = attributes[:'shipment_fee_list']).is_a?(Array)
          self.shipment_fee_list = value
        end
      end

      if attributes.key?(:'shipment_fee_adjustment_list')
        if (value = attributes[:'shipment_fee_adjustment_list']).is_a?(Array)
          self.shipment_fee_adjustment_list = value
        end
      end

      if attributes.key?(:'order_fee_list')
        if (value = attributes[:'order_fee_list']).is_a?(Array)
          self.order_fee_list = value
        end
      end

      if attributes.key?(:'order_fee_adjustment_list')
        if (value = attributes[:'order_fee_adjustment_list']).is_a?(Array)
          self.order_fee_adjustment_list = value
        end
      end

      if attributes.key?(:'direct_payment_list')
        if (value = attributes[:'direct_payment_list']).is_a?(Array)
          self.direct_payment_list = value
        end
      end
      ...
      if attributes.key?(:'shipment_item_list')
        if (value = attributes[:'shipment_item_list']).is_a?(Array)
          self.shipment_item_list = value
        end
      end

      if attributes.key?(:'shipment_item_adjustment_list')
        if (value = attributes[:'shipment_item_adjustment_list']).is_a?(Array)
          self.shipment_item_adjustment_list = value
        end
      end
    end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        klass = AmzSpApi::FinancesApiModel.const_get(type)
