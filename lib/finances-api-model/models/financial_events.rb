  ...
  class FinancialEvents
    ...
    def self.openapi_types
      {
        ...
        :'tds_reimbursement_event_list' => :'Array<TDSReimbursementEvent>',
        :'adhoc_disbursement_event_list' => :'Array<AdhocDisbursementEvent>',
        :'tax_withholding_event_list' => :'Array<TaxWithholdingEvent>',
        :'charge_refund_event_list' => :'Array<ChargeRefundEvent>',
        :'failed_adhoc_disbursement_event_list' => :'FailedAdhocDisbursementEventList',
        :'value_added_service_charge_event_list' => :'ValueAddedServiceChargeEventList',
        :'capacity_reservation_billing_event_list' => :'Array<CapacityReservationBillingEvent>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'tds_reimbursement_event_list')
        if (value = attributes[:'tds_reimbursement_event_list']).is_a?(Array)
          self.tds_reimbursement_event_list = value
        end
      end

      if attributes.key?(:'adhoc_disbursement_event_list')
        if (value = attributes[:'adhoc_disbursement_event_list']).is_a?(Array)
          self.adhoc_disbursement_event_list = value
        end
      end
      ...
      if attributes.key?(:'charge_refund_event_list')
        if (value = attributes[:'charge_refund_event_list']).is_a?(Array)
          self.charge_refund_event_list = value
        end
      end
      ...
      if attributes.key?(:'capacity_reservation_billing_event_list')
        if (value = attributes[:'capacity_reservation_billing_event_list']).is_a?(Array)
          self.capacity_reservation_billing_event_list = value
        end
      end
    end
