  ...
  class RentalTransactionEvent
    ...
    def self.openapi_types
      {
        ...
        :'posted_date' => :'Time',
        :'rental_charge_list' => :'Array<ChargeComponent>',
        :'rental_fee_list' => :'Array<FeeComponent>',
        :'marketplace_name' => :'String',
        :'rental_initial_value' => :'Currency',
        :'rental_reimbursement' => :'Currency',
        :'rental_tax_withheld_list' => :'Array<TaxWithheldComponent>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'rental_charge_list')
        if (value = attributes[:'rental_charge_list']).is_a?(Array)
          self.rental_charge_list = value
        end
      end

      if attributes.key?(:'rental_fee_list')
        if (value = attributes[:'rental_fee_list']).is_a?(Array)
          self.rental_fee_list = value
        end
      end
      ...
      if attributes.key?(:'rental_tax_withheld_list')
        if (value = attributes[:'rental_tax_withheld_list']).is_a?(Array)
          self.rental_tax_withheld_list = value
        end
      end
    end
