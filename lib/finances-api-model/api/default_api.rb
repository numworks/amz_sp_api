...
module AmzSpApi::FinancesApiModel
  class DefaultApi
    ...
    # @option opts [Time] :financial_event_group_started_after A date used for selecting financial event groups that opened after (or at) a specified date and time, in ISO 8601 format. The date-time must be no later than two minutes before the request was submitted.
    ...
    def list_financial_event_groups_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListFinancialEventGroupsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"DefaultApi.list_financial_event_groups",
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :max_results_per_page The maximum number of results to return per page. If the response exceeds the maximum number of transactions or 10 MB, the API responds with &#39;InvalidInput&#39;. (default to 100)
    # @option opts [Time] :posted_after A date used for selecting financial events posted after (or at) a specified time. The date-time must be no later than two minutes before the request was submitted, in ISO 8601 date time format.
    ...
    def list_financial_events_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListFinancialEventsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"DefaultApi.list_financial_events",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :max_results_per_page The maximum number of results to return per page. If the response exceeds the maximum number of transactions or 10 MB, the API responds with &#39;InvalidInput&#39;. (default to 100)
    # @option opts [Time] :posted_after A date used for selecting financial events posted after (or at) a specified time. The date-time **must** be more than two minutes before the time of the request, in ISO 8601 date time format.
    # @option opts [Time] :posted_before A date used for selecting financial events posted before (but not at) a specified time. The date-time must be later than &#x60;PostedAfter&#x60; and no later than two minutes before the request was submitted, in ISO 8601 date time format. If &#x60;PostedAfter&#x60; and &#x60;PostedBefore&#x60; are more than 180 days apart, no financial events are returned. You must specify the &#x60;PostedAfter&#x60; parameter if you specify the &#x60;PostedBefore&#x60; parameter. Default: Now minus two minutes.
    # @option opts [String] :next_token A string token returned in the response of your previous request.
    # @return [ListFinancialEventsResponse]
    ...
    def list_financial_events_by_group_id_with_http_info(event_group_id, opts = {})
      ...
      # resource path
      local_var_path = '/finances/v0/financialEventGroups/{eventGroupId}/financialEvents'.sub('{' + 'eventGroupId' + '}', CGI.escape(event_group_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.list_financial_events_by_group_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_financial_events_by_order_id_with_http_info(order_id, opts = {})
      ...
      # resource path
      local_var_path = '/finances/v0/orders/{orderId}/financialEvents'.sub('{' + 'orderId' + '}', CGI.escape(order_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.list_financial_events_by_order_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
