...
module AmzSpApi::VendorTransactionStatusApiModel
  class VendorTransactionApi
    ...
    def get_transaction_with_http_info(transaction_id, opts = {})
      ...
      # resource path
      local_var_path = '/vendor/transactions/v1/transactions/{transactionId}'.sub('{' + 'transactionId' + '}', CGI.escape(transaction_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"VendorTransactionApi.get_transaction",
