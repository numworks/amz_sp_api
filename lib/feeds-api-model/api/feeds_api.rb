...
module AmzSpApi::FeedsApiModel
  class FeedsApi
    ...
    def cancel_feed_with_http_info(feed_id, opts = {})
      ...
      # resource path
      local_var_path = '/feeds/2020-09-04/feeds/{feedId}'.sub('{' + 'feedId' + '}', CGI.escape(feed_id.to_s))
    ...
    def get_feed_document_with_http_info(feed_document_id, opts = {})
      ...
      # resource path
      local_var_path = '/feeds/2020-09-04/documents/{feedDocumentId}'.sub('{' + 'feedDocumentId' + '}', CGI.escape(feed_document_id.to_s))
