...
module AmzSpApi::FeedsApiModel
  class FeedsApi
    ...
    def cancel_feed_with_http_info(feed_id, opts = {})
      ...
      # resource path
      local_var_path = '/feeds/2021-06-30/feeds/{feedId}'.sub('{' + 'feedId' + '}', CGI.escape(feed_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"FeedsApi.cancel_feed",
    ...
    # @param body [CreateFeedSpecification] 
    # @param [Hash] opts the optional parameters
    ...
    def create_feed_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateFeedResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FeedsApi.create_feed",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param body [CreateFeedDocumentSpecification] 
    # @param [Hash] opts the optional parameters
    ...
    def create_feed_document_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateFeedDocumentResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FeedsApi.create_feed_document",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_feed_document_with_http_info(feed_document_id, opts = {})
      ...
      # resource path
      local_var_path = '/feeds/2021-06-30/documents/{feedDocumentId}'.sub('{' + 'feedDocumentId' + '}', CGI.escape(feed_document_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FeedDocument'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FeedsApi.get_feed_document",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [Time] :created_since The earliest feed creation date and time for feeds included in the response, in ISO 8601 format. The default is 90 days ago. Feeds are retained for a maximum of 90 days.
    # @option opts [Time] :created_until The latest feed creation date and time for feeds included in the response, in ISO 8601 format. The default is now.
