  ...
  class Summary
    ...
    def self.openapi_types
      {
        ...
        :'number_of_offers' => :'Array<OfferCountType>',
        :'lowest_prices' => :'Array<LowestPriceType>',
        :'buy_box_prices' => :'Array<BuyBoxPriceType>',
        :'list_price' => :'MoneyType',
        :'competitive_price_threshold' => :'MoneyType',
        :'suggested_lower_price_plus_shipping' => :'MoneyType',
        :'sales_rankings' => :'Array<SalesRankType>',
        :'buy_box_eligible_offers' => :'Array<OfferCountType>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'number_of_offers')
        if (value = attributes[:'number_of_offers']).is_a?(Array)
          self.number_of_offers = value
        end
      end

      if attributes.key?(:'lowest_prices')
        if (value = attributes[:'lowest_prices']).is_a?(Array)
          self.lowest_prices = value
        end
      end

      if attributes.key?(:'buy_box_prices')
        if (value = attributes[:'buy_box_prices']).is_a?(Array)
          self.buy_box_prices = value
        end
      end
      ...
      if attributes.key?(:'sales_rankings')
        if (value = attributes[:'sales_rankings']).is_a?(Array)
          self.sales_rankings = value
        end
      end

      if attributes.key?(:'buy_box_eligible_offers')
        if (value = attributes[:'buy_box_eligible_offers']).is_a?(Array)
          self.buy_box_eligible_offers = value
        end
      end
