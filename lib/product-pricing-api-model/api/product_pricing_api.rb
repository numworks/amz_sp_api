...
module AmzSpApi::ProductPricingApiModel
  class ProductPricingApi
    ...
    # @param marketplace_id [String] A marketplace identifier. Specifies the marketplace for which prices are returned.
    # @param item_type [String] Indicates whether ASIN values or seller SKU values are used to identify items. If you specify Asin, the information in the response will be dependent on the list of Asins you provide in the Asins parameter. If you specify Sku, the information in the response will be dependent on the list of Skus you provide in the Skus parameter. Possible values: Asin, Sku.
    ...
    def get_competitive_pricing_with_http_info(marketplace_id, item_type, opts = {})
      ...
      allowable_values = ["Consumer", "Business"]
    ...
    # @param marketplace_id [String] A marketplace identifier. Specifies the marketplace for which prices are returned.
    # @param item_condition [String] Filters the offer listings to be considered based on item condition. Possible values: New, Used, Collectible, Refurbished, Club.
    ...
    def get_item_offers_with_http_info(marketplace_id, item_condition, asin, opts = {})
      ...
      # verify enum value
      allowable_values = ["New", "Used", "Collectible", "Refurbished", "Club"]
      if @api_client.config.client_side_validation && !allowable_values.include?(item_condition)
        fail ArgumentError, "invalid value for \"item_condition\", must be one of #{allowable_values}"
      end
      ...
      # resource path
      local_var_path = '/products/pricing/v0/items/{Asin}/offers'.sub('{' + 'Asin' + '}', CGI.escape(asin.to_s))
    ...
    # @param marketplace_id [String] A marketplace identifier. Specifies the marketplace for which prices are returned.
    # @param item_condition [String] Filters the offer listings based on item condition. Possible values: New, Used, Collectible, Refurbished, Club.
    # @param seller_sku [String] Identifies an item in the given marketplace. SellerSKU is qualified by the seller&#39;s SellerId, which is included with every operation that you submit.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :customer_type Indicates whether to request Consumer or Business offers. Default is Consumer.
    # @return [GetOffersResponse]
    ...
    def get_listing_offers_with_http_info(marketplace_id, item_condition, seller_sku, opts = {})
      ...
      # resource path
      local_var_path = '/products/pricing/v0/listings/{SellerSKU}/offers'.sub('{' + 'SellerSKU' + '}', CGI.escape(seller_sku.to_s))
    ...
    def get_pricing_with_http_info(marketplace_id, item_type, opts = {})
      ...
      allowable_values = ["New", "Used", "Collectible", "Refurbished", "Club"]
      if @api_client.config.client_side_validation && opts[:'item_condition'] && !allowable_values.include?(opts[:'item_condition'])
        fail ArgumentError, "invalid value for \"item_condition\", must be one of #{allowable_values}"
      end
      allowable_values = ["B2C", "B2B"]
