...
describe AmzSpApi::ProductPricingApiModel::FeaturedOfferExpectedPriceResponseBody do
  let(:instance) { AmzSpApi::ProductPricingApiModel::FeaturedOfferExpectedPriceResponseBody.new }
