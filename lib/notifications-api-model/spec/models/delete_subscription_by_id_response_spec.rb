...
describe AmzSpApi::NotificationsApiModel::DeleteSubscriptionByIdResponse do
  let(:instance) { AmzSpApi::NotificationsApiModel::DeleteSubscriptionByIdResponse.new }
