...
module AmzSpApi::NotificationsApiModel
  class NotificationsApi
    ...
    # @param notification_type [String] The type of notification.   For more information about notification types, see [the Notifications API Use Case Guide](https://github.com/amzn/selling-partner-api-docs/blob/main/guides/en-US/use-case-guides/notifications-api-use-case-guide/notifications-use-case-guide-v1.md).
    ...
    def create_subscription_with_http_info(notification_type, body, opts = {})
      ...
      # verify enum value
      allowable_values = ["ANY_OFFER_CHANGED", "FEED_PROCESSING_FINISHED", "FBA_OUTBOUND_SHIPMENT_STATUS", "FEE_PROMOTION", "FULFILLMENT_ORDER_STATUS", "REPORT_PROCESSING_FINISHED", "BRANDED_ITEM_CONTENT_CHANGE", "ITEM_PRODUCT_TYPE_CHANGE", "LISTINGS_ITEM_STATUS_CHANGE", "LISTINGS_ITEM_ISSUES_CHANGE", "MFN_ORDER_STATUS_CHANGE", "B2B_ANY_OFFER_CHANGED", "ACCOUNT_STATUS_CHANGED"]
      if @api_client.config.client_side_validation && !allowable_values.include?(notification_type)
        fail ArgumentError, "invalid value for \"notification_type\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
