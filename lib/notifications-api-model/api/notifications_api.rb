...
module AmzSpApi::NotificationsApiModel
  class NotificationsApi
    ...
    # @param body [CreateDestinationRequest] 
    ...
    def create_destination_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateDestinationResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NotificationsApi.create_destination",
    ...
    # @param notification_type [String] The type of notification.   For more information about notification types, see [the Notifications API Use Case Guide](doc:notifications-api-v1-use-case-guide).
    # @param body [CreateSubscriptionRequest] 
    # @param [Hash] opts the optional parameters
    # @return [CreateSubscriptionResponse]
    def create_subscription(notification_type, body, opts = {})
      data, _status_code, _headers = create_subscription_with_http_info(notification_type, body, opts)
      data
    end
    ...
    def create_subscription_with_http_info(notification_type, body, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/notifications/v1/subscriptions/{notificationType}'.sub('{' + 'notificationType' + '}', CGI.escape(notification_type.to_s))
      ...
      new_options = opts.merge(
        :operation => :"NotificationsApi.create_subscription",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_destination_with_http_info(destination_id, opts = {})
      ...
      # resource path
      local_var_path = '/notifications/v1/destinations/{destinationId}'.sub('{' + 'destinationId' + '}', CGI.escape(destination_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DeleteDestinationResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NotificationsApi.delete_destination",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_subscription_by_id_with_http_info(subscription_id, notification_type, opts = {})
      ...
      # resource path
      local_var_path = '/notifications/v1/subscriptions/{notificationType}/{subscriptionId}'.sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s)).sub('{' + 'notificationType' + '}', CGI.escape(notification_type.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DeleteSubscriptionByIdResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NotificationsApi.delete_subscription_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_destination_with_http_info(destination_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetDestinationResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NotificationsApi.get_destination",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_destinations_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetDestinationsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NotificationsApi.get_destinations",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_subscription_with_http_info(notification_type, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"NotificationsApi.get_subscription",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_subscription_by_id_with_http_info(subscription_id, notification_type, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetSubscriptionByIdResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NotificationsApi.get_subscription_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
