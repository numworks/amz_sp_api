...
module AmzSpApi::AplusContentApiModel
  class AplusContentApi
    ...
    # @param post_content_document_request [PostContentDocumentRequest] The content document request details.
    ...
    def create_content_document_with_http_info(marketplace_id, post_content_document_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(post_content_document_request)

      # return_type
      return_type = opts[:debug_return_type] || 'PostContentDocumentResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AplusContentApi.create_content_document",
    ...
    # @param content_reference_key [String] The unique reference key for the A+ Content document. A content reference key cannot form a permalink and may change in the future. A content reference key is not guaranteed to match any A+ Content identifier.
    # @param marketplace_id [String] The identifier for the marketplace where the A+ Content is published.
    ...
    def get_content_document_with_http_info(content_reference_key, marketplace_id, included_data_set, opts = {})
      ...
      # resource path
      local_var_path = '/aplus/2020-11-01/contentDocuments/{contentReferenceKey}'.sub('{' + 'contentReferenceKey' + '}', CGI.escape(content_reference_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetContentDocumentResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AplusContentApi.get_content_document",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_content_document_asin_relations_with_http_info(content_reference_key, marketplace_id, opts = {})
      ...
      allowable_values = ["METADATA"]
      if @api_client.config.client_side_validation && opts[:'included_data_set'] && !opts[:'included_data_set'].all? { |item| allowable_values.include?(item) }
        fail ArgumentError, "invalid value for \"included_data_set\", must include one of #{allowable_values}"
      end
      ...
      # resource path
      local_var_path = '/aplus/2020-11-01/contentDocuments/{contentReferenceKey}/asins'.sub('{' + 'contentReferenceKey' + '}', CGI.escape(content_reference_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListContentDocumentAsinRelationsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AplusContentApi.list_content_document_asin_relations",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_content_document_approval_submission_with_http_info(content_reference_key, marketplace_id, opts = {})
      ...
      # resource path
      local_var_path = '/aplus/2020-11-01/contentDocuments/{contentReferenceKey}/approvalSubmissions'.sub('{' + 'contentReferenceKey' + '}', CGI.escape(content_reference_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PostContentDocumentApprovalSubmissionResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AplusContentApi.post_content_document_approval_submission",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param content_reference_key [String] The unique reference key for the A+ Content document. A content reference key cannot form a permalink and may change in the future. A content reference key is not guaranteed to match any A+ content identifier.
    # @param marketplace_id [String] The identifier for the marketplace where the A+ Content is published.
    # @param post_content_document_asin_relations_request [PostContentDocumentAsinRelationsRequest] The content document ASIN relations request details.
    # @param [Hash] opts the optional parameters
    ...
    def post_content_document_asin_relations_with_http_info(content_reference_key, marketplace_id, post_content_document_asin_relations_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(post_content_document_asin_relations_request)

      # return_type
      return_type = opts[:debug_return_type] || 'PostContentDocumentAsinRelationsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AplusContentApi.post_content_document_asin_relations",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_content_document_suspend_submission_with_http_info(content_reference_key, marketplace_id, opts = {})
      ...
      # resource path
      local_var_path = '/aplus/2020-11-01/contentDocuments/{contentReferenceKey}/suspendSubmissions'.sub('{' + 'contentReferenceKey' + '}', CGI.escape(content_reference_key.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PostContentDocumentSuspendSubmissionResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AplusContentApi.post_content_document_suspend_submission",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def search_content_documents_with_http_info(marketplace_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SearchContentDocumentsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AplusContentApi.search_content_documents",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def search_content_publish_records_with_http_info(marketplace_id, asin, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SearchContentPublishRecordsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AplusContentApi.search_content_publish_records",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_content_document_with_http_info(content_reference_key, marketplace_id, post_content_document_request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"AplusContentApi.update_content_document",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def validate_content_document_asin_relations_with_http_info(marketplace_id, post_content_document_request, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ValidateContentDocumentAsinRelationsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AplusContentApi.validate_content_document_asin_relations",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
