...
module AmzSpApi::AplusContentApiModel
  ...
  class StandardComparisonProductBlock
    ...
    def list_invalid_properties
      ...
      if !@metrics.nil? && @metrics.length > 10
        invalid_properties.push('invalid value for "metrics", number of items must be less than or equal to 10.')
      end

      if !@metrics.nil? && @metrics.length < 0
        invalid_properties.push('invalid value for "metrics", number of items must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@metrics.nil? && @metrics.length > 10
      return false if !@metrics.nil? && @metrics.length < 0
      true
    end
    ...
    def metrics=(metrics)
      if !metrics.nil? && metrics.length > 10
        fail ArgumentError, 'invalid value for "metrics", number of items must be less than or equal to 10.'
      end

      if !metrics.nil? && metrics.length < 0
        fail ArgumentError, 'invalid value for "metrics", number of items must be greater than or equal to 0.'
      end
