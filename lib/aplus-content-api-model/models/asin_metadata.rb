...
module AmzSpApi::AplusContentApiModel
  ...
  class AsinMetadata
    ...
    def self.openapi_types
      {
        :'asin' => :'String',
        :'badge_set' => :'Array<AsinBadge>',
        :'parent' => :'String',
        :'title' => :'String',
        :'image_url' => :'String',
        :'content_reference_key_set' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'badge_set')
        if (value = attributes[:'badge_set']).is_a?(Array)
          self.badge_set = value
        end
      end
      ...
      if attributes.key?(:'content_reference_key_set')
        if (value = attributes[:'content_reference_key_set']).is_a?(Array)
          self.content_reference_key_set = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@parent.nil? && @parent.to_s.length < 10
        invalid_properties.push('invalid value for "parent", the character length must be great than or equal to 10.')
      end
    ...
    def valid?
      ...
      return false if !@parent.nil? && @parent.to_s.length < 10
    ...
    # Custom attribute writer method with validation
    # @param [Object] badge_set Value to be assigned
    def badge_set=(badge_set)
      @badge_set = badge_set
    end
    ...
    def parent=(parent)
      if !parent.nil? && parent.to_s.length < 10
        fail ArgumentError, 'invalid value for "parent", the character length must be great than or equal to 10.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] content_reference_key_set Value to be assigned
    def content_reference_key_set=(content_reference_key_set)
