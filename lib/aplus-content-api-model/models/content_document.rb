  ...
  class ContentDocument
    ...
    def self.openapi_types
      {
        ...
        :'locale' => :'String',
        :'content_module_list' => :'Array<ContentModule>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'content_module_list')
        if (value = attributes[:'content_module_list']).is_a?(Array)
          self.content_module_list = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @content_module_list.length > 100
        invalid_properties.push('invalid value for "content_module_list", number of items must be less than or equal to 100.')
      end

      if @content_module_list.length < 1
        invalid_properties.push('invalid value for "content_module_list", number of items must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @content_module_list.length > 100
      return false if @content_module_list.length < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] content_module_list Value to be assigned
    def content_module_list=(content_module_list)
      if content_module_list.nil?
        fail ArgumentError, 'content_module_list cannot be nil'
      end

      if content_module_list.length > 100
        fail ArgumentError, 'invalid value for "content_module_list", number of items must be less than or equal to 100.'
      end

      if content_module_list.length < 1
        fail ArgumentError, 'invalid value for "content_module_list", number of items must be greater than or equal to 1.'
      end
