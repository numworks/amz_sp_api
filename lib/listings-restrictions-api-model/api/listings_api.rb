...
module AmzSpApi::ListingsRestrictionsApiModel
  class ListingsApi
    ...
    def get_listings_restrictions_with_http_info(asin, seller_id, marketplace_ids, opts = {})
      ...
      allowable_values = ["new_new", "new_open_box", "new_oem", "refurbished_refurbished", "used_like_new", "used_very_good", "used_good", "used_acceptable", "collectible_like_new", "collectible_very_good", "collectible_good", "collectible_acceptable", "club_club"]
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RestrictionList'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ListingsApi.get_listings_restrictions",
