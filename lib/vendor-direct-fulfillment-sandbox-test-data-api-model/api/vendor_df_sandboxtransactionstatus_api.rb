...
module AmzSpApi::VendorDirectFulfillmentSandboxTestDataApiModel
  class VendorDFSandboxtransactionstatusApi
    ...
    # @param transaction_id [String] The transaction identifier returned in the response to the generateOrderScenarios operation.
    ...
    def get_order_scenarios_with_http_info(transaction_id, opts = {})
      ...
      # resource path
      local_var_path = '/vendor/directFulfillment/sandbox/2021-10-28/transactions/{transactionId}'.sub('{' + 'transactionId' + '}', CGI.escape(transaction_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"VendorDFSandboxtransactionstatusApi.get_order_scenarios",
