...
describe AmzSpApi::FbaInboundEligibilityApiModel::ItemEligibilityPreview do
  let(:instance) { AmzSpApi::FbaInboundEligibilityApiModel::ItemEligibilityPreview.new }
