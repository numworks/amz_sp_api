...
module AmzSpApi::FbaInventoryApiModel
  class FbaInventoryApi
    ...
    def get_inventory_summaries_with_http_info(granularity_type, granularity_id, marketplace_ids, opts = {})
      ...
      # verify enum value
      allowable_values = ["Marketplace"]
      if @api_client.config.client_side_validation && !allowable_values.include?(granularity_type)
        fail ArgumentError, "invalid value for \"granularity_type\", must be one of #{allowable_values}"
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetInventorySummariesResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FbaInventoryApi.get_inventory_summaries",
