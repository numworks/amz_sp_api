...
describe 'OrdersV0Api' do
  ...
  describe 'test an instance of OrdersV0Api' do
    it 'should create an instance of OrdersV0Api' do
      expect(@api_instance).to be_instance_of(AmzSpApi::OrdersApiModel::OrdersV0Api)
    end
  end
  ...
  # @param payload Request body of confirmShipment.
  ...
  # @param order_id An orderId is an Amazon-defined order identifier, in 3-7-7 format.
  # @param payload The request body for the updateVerificationStatus operation.
  # @param [Hash] opts the optional parameters
  # @return [nil]
