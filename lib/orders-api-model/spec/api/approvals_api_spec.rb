...
# Unit tests for AmzSpApi::OrdersApiModel::ApprovalsApi
...
describe 'ApprovalsApi' do
  ...
  describe 'test an instance of ApprovalsApi' do
    it 'should create an instance of ApprovalsApi' do
      expect(@api_instance).to be_instance_of(AmzSpApi::OrdersApiModel::ApprovalsApi)
    end
  end
  ...
  # @param payload The request body for the updateOrderItemsApprovals operation.
  # @param [Hash] opts the optional parameters
  # @return [nil]
