  ...
  class Order
    ...
    def self.openapi_types
      {
        ...
        :'payment_execution_detail' => :'Array<PaymentExecutionDetailItem>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'payment_execution_detail')
        if (value = attributes[:'payment_execution_detail']).is_a?(Array)
          self.payment_execution_detail = value
        end
      end
      ...
      if attributes.key?(:'payment_method_details')
        if (value = attributes[:'payment_method_details']).is_a?(Array)
          self.payment_method_details = value
        end
      end
