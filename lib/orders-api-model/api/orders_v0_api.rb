...
module AmzSpApi::OrdersApiModel
  class OrdersV0Api
    ...
    # @param payload [ConfirmShipmentRequest] Request body of confirmShipment.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def confirm_shipment(order_id, payload, opts = {})
      confirm_shipment_with_http_info(order_id, payload, opts)
      nil
    end
    ...
    def confirm_shipment_with_http_info(order_id, payload, opts = {})
      ...
      if @api_client.config.client_side_validation && payload.nil?
        fail ArgumentError, "Missing the required parameter 'payload' when calling OrdersV0Api.confirm_shipment"
      end
      # resource path
      local_var_path = '/orders/v0/orders/{orderId}/shipmentConfirmation'.sub('{' + 'orderId' + '}', CGI.escape(order_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OrdersV0Api.confirm_shipment",
    ...
    def get_order_with_http_info(order_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"OrdersV0Api.get_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_order_address_with_http_info(order_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetOrderAddressResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"OrdersV0Api.get_order_address",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_order_buyer_info_with_http_info(order_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"OrdersV0Api.get_order_buyer_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_order_items_with_http_info(order_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetOrderItemsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"OrdersV0Api.get_order_items",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_order_items_buyer_info_with_http_info(order_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetOrderItemsBuyerInfoResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"OrdersV0Api.get_order_items_buyer_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_order_regulated_info_with_http_info(order_id, opts = {})
      ...
      # resource path
      local_var_path = '/orders/v0/orders/{orderId}/regulatedInfo'.sub('{' + 'orderId' + '}', CGI.escape(order_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetOrderRegulatedInfoResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"OrdersV0Api.get_order_regulated_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param marketplace_ids [Array<String>] A list of MarketplaceId values. Used to select orders that were placed in the specified marketplaces.  See the [Selling Partner API Developer Guide](doc:marketplace-ids) for a complete list of marketplaceId values.
    # @param [Hash] opts the optional parameters
    ...
    def get_orders_with_http_info(marketplace_ids, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'item_approval_types'].nil? && opts[:'item_approval_types'].length > 1
        fail ArgumentError, 'invalid value for "opts[:"item_approval_types"]" when calling OrdersV0Api.get_orders, number of items must be less than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'item_approval_status'].nil? && opts[:'item_approval_status'].length > 6
        fail ArgumentError, 'invalid value for "opts[:"item_approval_status"]" when calling OrdersV0Api.get_orders, number of items must be less than or equal to 6.'
      end
      ...
      new_options = opts.merge(
        :operation => :"OrdersV0Api.get_orders",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param order_id [String] An orderId is an Amazon-defined order identifier, in 3-7-7 format.
    # @param payload [UpdateVerificationStatusRequest] The request body for the updateVerificationStatus operation.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_verification_status(order_id, payload, opts = {})
      update_verification_status_with_http_info(order_id, payload, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_verification_status_with_http_info(order_id, payload, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'payload' is set
      if @api_client.config.client_side_validation && payload.nil?
        fail ArgumentError, "Missing the required parameter 'payload' when calling OrdersV0Api.update_verification_status"
      end
      # resource path
      local_var_path = '/orders/v0/orders/{orderId}/regulatedInfo'.sub('{' + 'orderId' + '}', CGI.escape(order_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OrdersV0Api.update_verification_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
