...
module AmzSpApi::VendorDirectFulfillmentTransactionsApiModel
  class VendorTransactionApi
    ...
    # @param transaction_id [String] Previously returned in the response to the POST request of a specific transaction.
    ...
    def get_transaction_status_with_http_info(transaction_id, opts = {})
      ...
      # resource path
      local_var_path = '/vendor/directFulfillment/transactions/2021-12-28/transactions/{transactionId}'.sub('{' + 'transactionId' + '}', CGI.escape(transaction_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"VendorTransactionApi.get_transaction_status",
