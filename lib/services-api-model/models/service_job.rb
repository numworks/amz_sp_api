...
module AmzSpApi::ServicesApiModel
  ...
  class ServiceJob
    ...
    def list_invalid_properties
      ...
      if !@service_job_id.nil? && @service_job_id.to_s.length > 100
        invalid_properties.push('invalid value for "service_job_id", the character length must be smaller than or equal to 100.')
      end

      if !@service_job_id.nil? && @service_job_id.to_s.length < 1
        invalid_properties.push('invalid value for "service_job_id", the character length must be great than or equal to 1.')
      end

      if !@service_order_id.nil? && @service_order_id.to_s.length > 20
        invalid_properties.push('invalid value for "service_order_id", the character length must be smaller than or equal to 20.')
      end

      if !@service_order_id.nil? && @service_order_id.to_s.length < 5
        invalid_properties.push('invalid value for "service_order_id", the character length must be great than or equal to 5.')
      end

      pattern = Regexp.new(/^[A-Z0-9]*$/)
      if !@marketplace_id.nil? && @marketplace_id !~ pattern
        invalid_properties.push("invalid value for \"marketplace_id\", must conform to the pattern #{pattern}.")
      end

      if !@store_id.nil? && @store_id.to_s.length > 100
        invalid_properties.push('invalid value for "store_id", the character length must be smaller than or equal to 100.')
      end
    ...
    def valid?
      return false if !@service_job_id.nil? && @service_job_id.to_s.length > 100
      return false if !@service_job_id.nil? && @service_job_id.to_s.length < 1
      ...
      return false if !@service_order_id.nil? && @service_order_id.to_s.length > 20
      return false if !@service_order_id.nil? && @service_order_id.to_s.length < 5
      return false if !@marketplace_id.nil? && @marketplace_id !~ Regexp.new(/^[A-Z0-9]*$/)
      return false if !@store_id.nil? && @store_id.to_s.length > 100
      return false if !@store_id.nil? && @store_id.to_s.length < 1
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] service_job_id Value to be assigned
    def service_job_id=(service_job_id)
      if !service_job_id.nil? && service_job_id.to_s.length > 100
        fail ArgumentError, 'invalid value for "service_job_id", the character length must be smaller than or equal to 100.'
      end

      if !service_job_id.nil? && service_job_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "service_job_id", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] service_order_id Value to be assigned
    def service_order_id=(service_order_id)
      if !service_order_id.nil? && service_order_id.to_s.length > 20
        fail ArgumentError, 'invalid value for "service_order_id", the character length must be smaller than or equal to 20.'
      end

      if !service_order_id.nil? && service_order_id.to_s.length < 5
        fail ArgumentError, 'invalid value for "service_order_id", the character length must be great than or equal to 5.'
      end
    ...
    def marketplace_id=(marketplace_id)
      pattern = Regexp.new(/^[A-Z0-9]*$/)
      if !marketplace_id.nil? && marketplace_id !~ pattern
        fail ArgumentError, "invalid value for \"marketplace_id\", must conform to the pattern #{pattern}."
      end
    ...
    def store_id=(store_id)
      if !store_id.nil? && store_id.to_s.length > 100
        fail ArgumentError, 'invalid value for "store_id", the character length must be smaller than or equal to 100.'
      end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        klass = AmzSpApi::ServicesApiModel.const_get(type)
