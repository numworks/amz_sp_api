...
module AmzSpApi::ServicesApiModel
  ...
  class AssociatedItem
    ...
    def list_invalid_properties
      ...
      if !@order_id.nil? && @order_id.to_s.length > 20
        invalid_properties.push('invalid value for "order_id", the character length must be smaller than or equal to 20.')
      end

      if !@order_id.nil? && @order_id.to_s.length < 5
    ...
    def valid?
      return false if !@order_id.nil? && @order_id.to_s.length > 20
      return false if !@order_id.nil? && @order_id.to_s.length < 5
    ...
    def order_id=(order_id)
      if !order_id.nil? && order_id.to_s.length > 20
        fail ArgumentError, 'invalid value for "order_id", the character length must be smaller than or equal to 20.'
      end
