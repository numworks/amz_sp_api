...
describe AmzSpApi::ServicesApiModel::AssignAppointmentResourcesResponsePayload do
  let(:instance) { AmzSpApi::ServicesApiModel::AssignAppointmentResourcesResponsePayload.new }
