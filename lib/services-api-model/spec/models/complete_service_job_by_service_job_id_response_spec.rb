...
describe AmzSpApi::ServicesApiModel::CompleteServiceJobByServiceJobIdResponse do
  let(:instance) { AmzSpApi::ServicesApiModel::CompleteServiceJobByServiceJobIdResponse.new }
