  ...
  class FeeDetail
    ...
    def self.openapi_types
      {
        ...
        :'final_fee' => :'MoneyType',
        :'included_fee_detail_list' => :'Array<IncludedFeeDetail>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'included_fee_detail_list')
        if (value = attributes[:'included_fee_detail_list']).is_a?(Array)
          self.included_fee_detail_list = value
        end
      end
    end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        klass = AmzSpApi::ProductFeesApiModel.const_get(type)
