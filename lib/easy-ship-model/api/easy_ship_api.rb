...
module AmzSpApi::EasyShipModel
  class EasyShipApi
    ...
    # @param create_scheduled_package_request [CreateScheduledPackageRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Package]
    def create_scheduled_package(create_scheduled_package_request, opts = {})
      data, _status_code, _headers = create_scheduled_package_with_http_info(create_scheduled_package_request, opts)
      data
    end
    ...
    def create_scheduled_package_with_http_info(create_scheduled_package_request, opts = {})
      ...
      if @api_client.config.client_side_validation && create_scheduled_package_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_scheduled_package_request' when calling EasyShipApi.create_scheduled_package"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_scheduled_package_request)
      ...
      new_options = opts.merge(
        :operation => :"EasyShipApi.create_scheduled_package",
    ...
    # @param create_scheduled_packages_request [CreateScheduledPackagesRequest] 
    # @param [Hash] opts the optional parameters
    # @return [CreateScheduledPackagesResponse]
    def create_scheduled_package_bulk(create_scheduled_packages_request, opts = {})
      data, _status_code, _headers = create_scheduled_package_bulk_with_http_info(create_scheduled_packages_request, opts)
      data
    end
    ...
    def create_scheduled_package_bulk_with_http_info(create_scheduled_packages_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && create_scheduled_packages_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_scheduled_packages_request' when calling EasyShipApi.create_scheduled_package_bulk"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_scheduled_packages_request)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateScheduledPackagesResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"EasyShipApi.create_scheduled_package_bulk",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param amazon_order_id [String] An Amazon-defined order identifier. Identifies the order that the seller wants to deliver using Amazon Easy Ship.
    ...
    def get_scheduled_package_with_http_info(amazon_order_id, marketplace_id, opts = {})
      ...
      if @api_client.config.client_side_validation && amazon_order_id.to_s.length > 255
        fail ArgumentError, 'invalid value for "amazon_order_id" when calling EasyShipApi.get_scheduled_package, the character length must be smaller than or equal to 255.'
      end

      if @api_client.config.client_side_validation && amazon_order_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "amazon_order_id" when calling EasyShipApi.get_scheduled_package, the character length must be great than or equal to 1.'
      end
      ...
      if @api_client.config.client_side_validation && marketplace_id.to_s.length > 255
        fail ArgumentError, 'invalid value for "marketplace_id" when calling EasyShipApi.get_scheduled_package, the character length must be smaller than or equal to 255.'
      end

      if @api_client.config.client_side_validation && marketplace_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "marketplace_id" when calling EasyShipApi.get_scheduled_package, the character length must be great than or equal to 1.'
      end
      ...
      new_options = opts.merge(
        :operation => :"EasyShipApi.get_scheduled_package",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ListHandoverSlotsRequest] :list_handover_slots_request 
    ...
    def list_handover_slots_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'list_handover_slots_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'ListHandoverSlotsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"EasyShipApi.list_handover_slots",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [UpdateScheduledPackagesRequest] :update_scheduled_packages_request 
    # @return [Packages]
    ...
    def update_scheduled_packages_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'update_scheduled_packages_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'Packages'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"EasyShipApi.update_scheduled_packages",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
