...
module AmzSpApi::EasyShipModel
  ...
  class CreateScheduledPackagesRequest
    ...
    def self.openapi_types
      {
        ...
        :'order_schedule_details_list' => :'Array<OrderScheduleDetails>',
        :'label_format' => :'LabelFormat'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @order_schedule_details_list.length < 1
        invalid_properties.push('invalid value for "order_schedule_details_list", number of items must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @order_schedule_details_list.length < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] order_schedule_details_list Value to be assigned
    def order_schedule_details_list=(order_schedule_details_list)
      if order_schedule_details_list.nil?
        fail ArgumentError, 'order_schedule_details_list cannot be nil'
      end

      if order_schedule_details_list.length < 1
        fail ArgumentError, 'invalid value for "order_schedule_details_list", number of items must be greater than or equal to 1.'
      end
