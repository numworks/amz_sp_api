...
module AmzSpApi::AuthorizationApiModel
  class AuthorizationApi
    ...
    # @param selling_partner_id [String] The seller ID of the seller for whom you are requesting Selling Partner API authorization. This must be the seller ID of the seller who authorized your application on the Marketplace Appstore.
    # @param developer_id [String] Your developer ID. This must be one of the developer ID values that you provided when you registered your application in Developer Central.
    # @param mws_auth_token [String] The MWS Auth Token that was generated when the seller authorized your application on the Marketplace Appstore.
    ...
    def get_authorization_code_with_http_info(selling_partner_id, developer_id, mws_auth_token, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAuthorizationCodeResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AuthorizationApi.get_authorization_code",
