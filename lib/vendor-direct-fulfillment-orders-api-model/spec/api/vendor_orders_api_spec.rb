...
describe 'VendorOrdersApi' do
  ...
  describe 'test an instance of VendorOrdersApi' do
    it 'should create an instance of VendorOrdersApi' do
      expect(@api_instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrdersApiModel::VendorOrdersApi)
    end
  end
  ...
  # @option opts [Boolean] :include_details When true, returns the complete purchase order details. Otherwise, only purchase order numbers are returned.
