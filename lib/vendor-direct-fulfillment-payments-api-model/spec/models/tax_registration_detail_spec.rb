...
describe AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::TaxRegistrationDetail do
  let(:instance) { AmzSpApi::VendorDirectFulfillmentPaymentsApiModel::TaxRegistrationDetail.new }
